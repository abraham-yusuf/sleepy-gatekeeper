          ...
          <div className="p-8 md:p-12 bg-white">
            ...
            <div className="mb-8">
              <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-6 font-mono text-sm">
                ...
                <span className="bg-neon-green text-black font-bold px-2 py-0.5 text-xs">$0.10</span>
              </div>
              <div className="border-t-2 border-gray-300 pt-6">
                <p className="text-lg text-gray-700 font-mono">Complete guide to building decentralized applications</p>
              </div>
            </div>
              ...
              <div className="my-8">
                <div className="win95-shadow bg-retro-gray p-3 mb-4">
                  ...
                  <p className="text-gray-600 font-mono text-xs">
                    Pay $0.10 USDC via trustless Solana escrow to access the full content.
                  </p>
                </div>
                <EscrowPayButton
                  creatorAddress={CREATOR_ADDRESS}
                  priceUsdc={0.1}
                  contentLabel="Web3 Development Starter Kit"
