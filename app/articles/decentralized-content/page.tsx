          ...
          <div className="p-8 md:p-12 bg-white">
            ...
            <div className="mb-8">
              <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-6 font-mono text-sm">
                <span>👤 By Bob Martinez</span>
                <span>•</span>
                <span>📅 January 22, 2024</span>
                <span className="bg-neon-green text-black font-bold px-2 py-0.5 text-xs">$0.02</span>
              </div>
              <div className="border-t-2 border-gray-300 pt-6">
                <p className="text-lg text-gray-700 font-mono">IPFS, Arweave, and the future of censorship-resistant publishing</p>
              </div>
            </div>
            ...
            {!isUnlocked && (
              <div className="my-8">
                ...
                <EscrowPayButton
                  ...
                  priceUsdc={0.02}
                  contentLabel="Decentralized Content Distribution"
