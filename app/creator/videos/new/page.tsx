  ...
  return (
    <div className="min-h-screen bg-[#008080] font-['MS_Sans_Serif',_'Microsoft_Sans_Serif',_sans-serif]">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <h1 className="text-4xl font-bold text-white mb-8 drop-shadow-[2px_2px_0px_rgba(0,0,0,1)]">Create New Video</h1>
        ...
        <div className="bg-[#c0c0c0] border-2 border-t-white border-l-white border-r-[#808080] border-b-[#808080] p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="videoUrl" className="block text-sm font-bold text-black mb-2">
                Video URL
              </label>
              <input
                type="url"
