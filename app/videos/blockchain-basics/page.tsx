          ...
          <div className="p-8 md:p-12 bg-white">
            ...
            <div className="mb-8">
              ...
              <div className="border-t-2 border-gray-300 pt-6">
                <p className="text-lg text-gray-700 font-mono">Everything you need to know about blockchain technology</p>
              </div>
            </div>
            ...
            {!isUnlocked && (
              <div className="my-8">
                ...
                <EscrowPayButton
                  ...
                  priceUsdc={0.05}
                  contentLabel="Blockchain Basics: A Complete Guide"
            ...
            {isUnlocked && (
              <div className="my-8">
                ...
                <div className="win95-recessed bg-black rounded-sm overflow-hidden p-1 mb-6">
                  <video controls className="w-full aspect-video" poster="/x402-logo-dark.png"><source src="https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4" type="video/mp4" /></video>
                </div>
