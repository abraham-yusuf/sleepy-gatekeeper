        ...
        <div className="win95-shadow bg-retro-gray rounded-sm">
          ...
          <div className="bg-gradient-to-r from-blue-900 to-blue-600 px-4 py-2">
            <h1 className="text-2xl font-bold text-white font-mono flex items-center gap-2">
              ...
              Smart Contracts: From Zero to Deploy
            </h1>
          </div>
          ...
          <div className="p-8 md:p-12 bg-white">
            ...
            <div className="mb-8">
              <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-6 font-mono text-sm">
                <span>👤 By Dev Chen</span>
                <span>•</span>
                <span>📅 January 25, 2024</span>
                <span className="bg-neon-green text-black font-bold px-2 py-0.5 text-xs">$0.08</span>
              </div>
              <div className="border-t-2 border-gray-300 pt-6">
                <p className="text-lg text-gray-700 font-mono">Write, test, and deploy your first smart contract on Solana devnet</p>
              </div>
            </div>
              ...
              <div className="my-8">
                <div className="win95-shadow bg-retro-gray p-3 mb-4">
                  ...
                  <p className="text-gray-600 font-mono text-xs">
                    Pay $0.08 USDC via trustless Solana escrow to access the full content.
                  </p>
                </div>
                <EscrowPayButton
                  creatorAddress={CREATOR_ADDRESS}
                  priceUsdc={0.08}
                  contentLabel="Smart Contracts: From Zero to Deploy"
            ...
            {isUnlocked && (
              <div className="my-8">
                ...
                <div className="win95-recessed bg-black rounded-sm overflow-hidden p-1 mb-6">
                  <video controls className="w-full aspect-video"><source src="https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4" type="video/mp4" /></video>
                </div>
