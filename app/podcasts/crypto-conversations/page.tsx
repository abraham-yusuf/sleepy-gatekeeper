        ...
        <div className="win95-shadow bg-retro-gray rounded-sm">
          ...
          <div className="bg-gradient-to-r from-blue-900 to-blue-600 px-4 py-2">
            <h1 className="text-2xl font-bold text-white font-mono flex items-center gap-2">
              ...
              Crypto Conversations: Market Cycles
            </h1>
          </div>
          ...
          <div className="p-8 md:p-12 bg-white">
            ...
            <div className="mb-8">
              ...
              <div className="border-t-2 border-gray-300 pt-6">
                <p className="text-lg text-gray-700 font-mono">Understanding crypto market cycles and long-term investing</p>
              </div>
            </div>
            ...
            {!isUnlocked && (
              <div className="my-8">
                ...
                <EscrowPayButton
                  ...
                  priceUsdc={0.02}
                  contentLabel="Crypto Conversations: Market Cycles"
            ...
            {isUnlocked && (
              <div className="my-8">
                ...
                <div className="win95-recessed bg-black rounded-sm overflow-hidden p-1 mb-6">
                  <audio controls className="w-full" src="https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3">Your browser does not support audio.</audio>
                </div>
